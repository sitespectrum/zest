          ...
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              children: <Widget>[
                ...
                // A régi Stack és Positioned helyett ez a blokk kell:
                Padding(
                  padding: const EdgeInsets.all(20),
                  child: CustomCard(
                    title: lang.getText("previous_workouts"), // Javítottam a kulcsot (previous_meals volt), ellenőrizd!
                                      ...
                                      children: [
                                        Expanded(
                                          child: PageView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              final List<UserWorkoutDto> workoutsForDay = grouped[day] ?? [];
                                              ...
                                              return Padding(
                                                ...
                                                child: Column(
                                                  children: [
                                                    Text(
                                                      DateFormat.yMd(calendarLocale).format(day),
                                                      ...
                                                      child: workoutsForDay.isEmpty
                                                          ? Center(
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  SizedBox(height: 8),
                                                                  Text(
                                                                    lang.getText("no_data_on_this_day"),
                                                                    style: TextStyle(
                                                          ...
                                                          : ListView.builder(
                                                              ...
                                                              itemBuilder: (context, i) {
                                                                ...
                                                                final displayName = (workout.customName.isNotEmpty)
                                                                    ? workout.customName
                                                                    : workout.workoutName;
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          IconButton(
                                                                            ...
                                                                            onPressed: () async {
                                                                              final success = await deleteMeal(workout.id);
                                                                              if (success) {
                                                                                setStateDialog(() {
                                                                                  grouped[day]!.removeAt(i);
                                                                                });
                                                                                setState(() {
                                                                                  _futureWorkouts = fetchUserWorkouts();
                                                                                });
                                                                          ...
                                                                          ...workout.exercises.map((exerciseData) {
                                                                            return Padding(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  Text(
                                                                                    exerciseData.exercise?.getName(langCode) ?? lang.getText("unknown_exercise"),
                                                                                    style: const TextStyle(
                                                                                      color: Colors.green,
                                                                                      fontWeight: FontWeight.bold,
                                                                                      fontSize: 14,
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Column(
                                                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                                                      children: exerciseData.sets.map((set) {
                                                                                        final isCardio = exerciseData.exercise?.category?.toLowerCase() == 'cardio';
                                                                                        final isBodyweight = exerciseData.exercise?.equipment?.toLowerCase() == 'body only' ||
                                                                                            exerciseData.exercise?.equipment?.toLowerCase() == 'none';
                                                                                        String textToShow = "";
                                                                                        if (isCardio) {
                                                    ...
                                                    ElevatedButton.icon(
                                                      onPressed: () async {
                                                        await Navigator.of(context).push(
                                                          MaterialPageRoute(
                                                            builder: (_) => CWorkoutPage(selectedDay: tempSelectedDay),
                                                          ),
                                                        );
                                                        setState(() {
                                                      ...
                                                      label: Text(lang.getText("add_new_workout")),
                                        ...
                                        Padding(
                                          ...
                                          child: FilledButton(
                                            ...
                                            child: Text(lang.getText("close"), style: TextStyle(color: Colors.red)),
                                          ),
                                        ),
                                      ],
                                    ),
