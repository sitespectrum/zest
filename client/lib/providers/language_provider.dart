...
class LanguageProvider with ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'hu': {
      ...
      'kicked': 'kirúgva!',
      'someones_profile': 'profilja',
      'create_session_first': 'Hozz létre egy eseményt először!',
      'Host': 'Házigazda',
      'guest': 'Vendég',
      'session_stopped': 'Esemény leállítva.',
      'you_left_the_session': 'Kiléptél az eseményből',
      'location_needed': 'A helymeghatározás szükséges a megosztáshoz!',
      'nfc_stopped': 'NFC leállítva.',
      'quit': 'Kilépés',
      'view_profile': 'Profil megtekintése',
      'kick_user': 'Felhaszn. kirúgása',
      'send_friend_request': 'Barátkérelem küldése',
      'invite_friends' : 'Barátok meghívása',
      'no_valid_sets': 'Nincsenek érvényes szettek!',
      'end_workout': 'Edzés befejezése',
      'leave_workout': 'Kilépés az edzésből',
      'end_workout_description': 'Biztosan le akarod állítani a közös edzést? Ez mindenkinél megszakítja a folyamatot!',
      'leave_workout_description': 'Biztosan ki akarsz lépni a közös edzésből? A többiek folytathatják nélküled.',
      'send_to_background': 'Csak háttérbe rakom',
      'your_turn': 'Te jössz!',
      'finish_turn': 'Köröm befejezése',
      'waiting_for': 'Várakozás rá:',
      'skip_player': 'Játékos átugrása',
      'results_in_this_turn': 'Eddigi eredmények ebben a körben:',
      'no_results_yet': 'Még senki nem fejezte be...',
      'shared_workout_summary': 'Edzés összesítő',
      'great_job_everyone': 'Szép munka mindenkinek!',
    ...
    'en': {
      ...
      'invite': 'Invite',
      'copied_to_clipboard': 'Copied to clickboard!',
      'kicked': 'kicked!',
      'someones_profile': "'s profile",
      'create_session_first': 'Create session first!',
      'Host': 'Host',
      'guest': 'Guest',
      'session_stopped': 'Session stopped.',
      'you_left_the_session': 'You left the session.',
      'location_needed': 'Location needed for sharing!',
      'nfc_stopped': 'NFC stopped',
      'quit': 'Quit',
      'view_profile': 'View profile',
      'kick_user': 'Kick user',
      'send_friend_request': 'Send friend request',
      'invite_friends' : 'Invite friends',
      'no_valid_sets': 'No valid sets!',
      'end_workout': 'End workout',
      'leave_workout': 'Leave workout',
      'end_workout_description': 'Are you sure you want to end the shared workout? This will stop the workout for everyone!',
      'leave_workout_description': 'Are you sure you want to leave the shared workout? The others can continue without you.',
      'send_to_background': 'Just send to background',
      'your_turn': 'Your turn!',
      'finish_turn': 'Finish turn',
      'waiting_for': 'Waiting for:',
      'skip_player': 'Skip player',
      'results_in_this_turn': 'Results in this turn:',
      'no_results_yet': 'No results yet...',
      'shared_workout_summary': 'Shared workout summary',
      'great_job_everyone': 'Great job everyone!',
